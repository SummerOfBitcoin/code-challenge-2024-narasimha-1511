...
// import fs from "fs";
import { SHA256 } from "./Helpers/Hashes.js";
  ...
  vin: [
    {
      ...
      prevout: {
        ...
        scriptpubkey_asm:
          "OP_0 OP_PUSHBYTES_20 d5bfb7a6d05d44c1e14443919b30d284c0c0a10a",
  ...
  vout: [
    {
      ...
      scriptpubkey_asm:
        "OP_HASH160 OP_PUSHBYTES_20 50feb99697a4901d3fe082eca341204fb6711b94 OP_EQUAL",
      scriptpubkey_type: "p2sh",
...
console.log(
  SHA256("dba7615c48105027257f243d3dbacae3ab54c904207f9a7eee7b479d64fa5dc1")
);
